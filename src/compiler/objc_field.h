    ...
    namespace protobuf {
        namespace compiler {
            namespace objectivec {
                ...
                public:
                    explicit FieldGeneratorMap(const Descriptor* descriptor, const FileDescriptor* file);
                    ~FieldGeneratorMap();
                ...
                private:
                    ...
                    static FieldGenerator* MakeGenerator(const FieldDescriptor* field, const FileDescriptor* file);
