...
namespace google { namespace protobuf { namespace compiler { namespace objectivec {
    ...
    MessageFieldGenerator::MessageFieldGenerator(const FieldDescriptor* descriptor, const FileDescriptor* file)
    : descriptor_(descriptor) {
        SetMessageVariables(descriptor, file, &variables_);
    }
    ...
    RepeatedMessageFieldGenerator::RepeatedMessageFieldGenerator(const FieldDescriptor* descriptor, const FileDescriptor* file)
    : descriptor_(descriptor) {
        SetMessageVariables(descriptor, file, &variables_);
    }
